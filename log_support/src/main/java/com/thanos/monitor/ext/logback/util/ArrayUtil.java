 ...
 *
 * @author peiheng.zph created on 17/2/14 上午11:37
 * @version 1.0
 */
public final class ArrayUtil {
   ...
   *
   * @param array an array whose elements are either a {@link java.util.Map.Entry} or an Array containing at least two
   ...
   * @throws IllegalArgumentException if the array contains elements other than {@link java.util.Map.Entry} and an
   *                                  Array
   */
   ...
   * @param objectToFind the object to find, may be {@code null}
   * @return the last index of the object within the array, {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code
   * null} array input
   */
   ...
   * @return the last index of the value within the array, {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code
   * null} array input
   */
